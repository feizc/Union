...
def parse_args():
    ...
    parser.add_argument("--checkpoint-path", type=str, default='/mnt/dolphinfs/hdd_pool/docker/user/hadoop-mtcv/feizhengcong/clip/union/ckpt', help='checkpoint path')
    parser.add_argument(
    ...
    parser.add_argument(
        "--tensorboard_path", type=str, default="/mnt/dolphinfs/hdd_pool/docker/user/hadoop-mtcv/feizhengcong/clip/union/tensorboard/union",
    )
...
def main(): 
    ...
    for epoch in range(32): 
        ...
        if is_master(args):
            print('save modeling')
            torch.save(model.state_dict(), '/mnt/dolphinfs/hdd_pool/docker/user/hadoop-mtcv/feizhengcong/clip/union/ckpt/o_' + str(epoch) + '.pt') 
